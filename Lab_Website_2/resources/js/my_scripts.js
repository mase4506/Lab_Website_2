...
function switchPlayers(playerNum)
{
	...
	document.getElementById("player_img").atl = players[playerNum].alt;
	...
	document.getElementById("avg_p_yards").innerHTML = Math.floor(avgP);

	var avgRec = players[playerNum].receiving_yards / players[playerNum].games_played;
	document.getElementById("avg_rec_yards").innerHTML = Math.floor(avgRec);

	var avgR = players[playerNum].rushing_yards / players[playerNum].games_played;
	document.getElementById("avg_r_yards").innerHTML = Math.floor(avgR);
}
